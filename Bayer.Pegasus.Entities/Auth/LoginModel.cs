...
namespace Bayer.Pegasus.Entities.Auth
{
    ...
    public partial class LoginModel :  IEquatable<LoginModel>
    {
        ...
        public LoginModel(string AppId = default(string), string Login = default(string), string Password = default(string), string Ip = default(string), string CultureName = default(string))
        {
            this.AppId = AppId;
            this.Login = Login;
