...
{
    public class SelloutEvolutionController : Base.LoggedBaseController
    {
        ...
        public SelloutEvolutionController(ILogger<SelloutEvolutionController> logger, IHttpContextAccessor accessor,
        ...
        public IActionResult Index()
        {
            ...
            ViewData["Title"] = "Evolução de Sell Out";
        ...
        public JsonResult DataChart([FromBody]JObject data)
        {
            ...
            using (var selloutBO = new Bayer.Pegasus.Business.SelloutBO())
            {
                ...
                var feedbackService = selloutBO.ValidateSellOutEvolutionKPI(User, data);
                ...
                if (feedbackService.Success)
                {
                    ...
                    if (data["ReportDateViewModel"] != null)
                    {
                        ...
                        var chartData = selloutBO.GetSellOutEvolutionKPI(User, partners, units, clients, brands, products, cities, reportInterval, groupBy, typeDataChart);


                        if (chartData.Count == 1)
                        {
                            chartData.First().Color = "#0091DE";
                        }
                        ...
                        results["ticks"] = Bayer.Pegasus.Utils.DateUtils.GetJArrayTicks(reportInterval, true);
                    ...
                    else
                    {
                        if (!string.IsNullOrEmpty(intervalDataChart))
                        {
                            ...
                            var chartData = selloutBO.GetSellOutEvolutionKPI(User, partners, units, clients, brands, products, cities, reportDateInterval, groupBy, typeDataChart);
                            ...
                            results["ticks"] = Bayer.Pegasus.Utils.DateUtils.GetJArrayTicks(reportDateInterval, true);
