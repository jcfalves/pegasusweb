...
{
    public class TopStockProductsController : Base.LoggedBaseController
    {
        ...
        public TopStockProductsController(ILogger<TopStockProductsController> logger, IHttpContextAccessor accessor,
        ...
        public IActionResult Index()
        {
            ...
            ViewData["Title"] = "Top Produtos em Estoque";
        ...
        public JsonResult DataChart([FromBody]JObject data) {
            ...
            using (var productBO = new Bayer.Pegasus.Business.ProductBO())
            {
                ...
                var feedbackService = productBO.ValidateTopStockKPI(User, data);
                ...
                if (feedbackService.Success)
                {
                    ...
                    {
                        kpis = productBO.GetTopStockKPI(User, numberProducts, int.Parse(year), partners, units, groupByBrands);
                    }
                    else
                    {
                        if (!string.IsNullOrEmpty(intervalDataChart))
                        {
                            ...
                            kpis = productBO.GetTopStockKPI(User, numberProducts, reportDateInterval, partners, units, groupByBrands);
