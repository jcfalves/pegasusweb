...
(function (factory) {
    ...
    DragElement.prototype.updatePosition = function (event) {
        ...
        this.element.style.top = (getEventCoord(event, 'pageY') - window.pageYOffset - ($(this.element).height()*1.5)) + 'px';
        this.element.style.left = (getEventCoord(event, 'pageX') - window.pageXOffset - $('.modal-content').offset().left) + 'px';
    };
